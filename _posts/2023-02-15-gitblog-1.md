...
## 1. 저장소(repository) 생성
<center><img src=../assets/img/post/2023-02-15/1_git_main.png></img></center><br>
먼저 github main에 있는 **'New'** 버튼을 눌러 새로운 저장소를 생성한다. <br>
<br>
<center><img src=../assets/img/post/2023-02-15/2_repo_name.png></img></center><br>
...
<br>
<center><img src=../assets/img/post/2023-02-15/3_repo_other_setting.png></img></center><br>
공유 설정은 public으로 하고, Add a README file을 선택한다. 나머지 설정은 그대로 두고 'Create repository'를 누르면 저장소 생성이 완료된다.<br>
<br>

## 2. github 저장소 복사
<center><img src=../assets/img/post/2023-02-15/4_repo_main.png width=80% height=80%></img></center><br>
...
<center><img src=../assets/img/post/2023-02-15/5_wsl_clone.png width=80% height=80%></img></center><br>
...
```
<center><img src=../assets/img/post/2023-02-15/6_push_index.png width=80% height=80%></img></center><br>
<center><img src=../assets/img/post/2023-02-15/7_main_pushed.png width=80% height=80%></img></center><br>
...
<center><img src=../assets/img/post/2023-02-15/8_page_setting.png width=80% height=80%></img></center><br>
설정 후 페이지를 새로고침 하면 위와 같은 사진 처럼 'Your site is live at ...'과 같은 메시지가 위에 뜬다. 그럼 해당 링크를 클릭해 들어가보면 정상적으로 사이트가 만들어진 것을 확인할 수 있다.<br>
<br>

<center><img src=../assets/img/post/2023-02-15/9_complete.png width=80% height=80%></img></center><br>
